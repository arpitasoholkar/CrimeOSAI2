...
//   // Land on the latest step whenever the timeline loads or grows.
//   useEffect(() => {
...
//     const el = trackRef.current
//     if (!el) return
//     drag.current = { startX: e.pageX, startScroll: el.scrollLeft }
//     setDragging(true)
//   }
//   const onMouseMove = (e) => {
//     if (!dragging) return
...
//           {timeline.length > 0 && (
//             <p className={styles.metaText}>Latest {Math.min(timeline.length, 10)} updates from your investigation</p>
//           )}
//         </div>
//         {timeline.length > 0 && (
...
//                       </span>
//                     )}
//                     <p className={`${styles.timelineStepLabel} ${isCurrent ? styles.timelineStepLabelCurrent : ''}`}>
...
//             Showing latest {timeline.length} update{timeline.length === 1 ? '' : 's'}. New updates appear on the right — swipe or use the arrows to see earlier ones.
//           </p>
//         </>
//       ) : (
